...
Während 60.000 IP-Regeln eine Standard-NAS-Firewall (wie die von UGREEN oder Synology) überlasten könnten, ist diese Liste als **DNS- oder IP-Blockliste** für spezialisierte Werbe- und Trackingfilter optimiert.
